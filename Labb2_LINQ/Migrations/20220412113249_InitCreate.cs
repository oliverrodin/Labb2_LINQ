    ...
    public partial class InitCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Classes_Courses", x => new { x.ClassId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_Classes_Courses_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Classes_Courses_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classes_Courses_CourseId",
